...
#define SENSOR_SERVICE_UUID     QUATERNION_SERV_UUID
#define SENSOR_DATA_UUID        QUATERNION_DATA_UUID
#define SENSOR_CONFIG_UUID      QUATERNION_CONF_UUID
#define SENSOR_PERIOD_UUID      QUATERNION_PERI_UUID

#define SENSOR_SERVICE          QUATERNION_SERVICE
#define SENSOR_DATA_LEN         QUATERNION_DATA_LEN

#define SENSOR_DATA_DESCR       "Quat Data"
#define SENSOR_CONFIG_DESCR     "Quat Conf."
#define SENSOR_PERIOD_DESCR     "Quat Period"
 ...
 */
bStatus_t Quat_AddService( uint32 services )
{
 ...
 */
bStatus_t Quat_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Quat_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Quat_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
